...
function statusStyle(status: string) {
  switch (status) {
    case "Completed":
      return { bg: "var(--success-surface)", color: "var(--success-text)" };
    case "Scheduled":
      return { bg: "var(--purple-surface)", color: "var(--purple-text)" };
    case "Confirmed":
      return { bg: "var(--teal-surface)", color: "var(--teal-text)" };
    default:
      return { bg: "var(--warning-surface)", color: "var(--warning-text)" };
  }
}
          ...
          >
            ...
            <div className="px-5 pb-5 pt-2">
              <button
                ...
                onMouseOver={(e) => {
                  e.currentTarget.style.background = "#48C4C6";
